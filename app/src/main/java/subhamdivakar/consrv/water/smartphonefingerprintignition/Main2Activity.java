...
public class Main2Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Glide.with(Main2Activity.this).load("file:///android_asset/iot.gif").asGif().diskCacheStrategy(DiskCacheStrategy.SOURCE).crossFade().into(img1);
    ...
    public void start(View view)
    {
        ...
        Intent obj=new Intent(Main2Activity.this,ReceiveData.class);
        startActivity(obj);
    }
